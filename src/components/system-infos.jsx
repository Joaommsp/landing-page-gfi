...
import user03 from "@/assets/img/section-system-infos/user-03.jpg";

export default function SystemInfos() {
  return (
              ...
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  ...
                  >
                    ...
                    <path
                      className="text-primary-600 dark:text-yellow-500"
                      d="M3 72H209"
                      stroke="currentColor"
                      strokeWidth="6"
                      strokeLinecap="round"
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Certificação SSL, logs de auditoria completos e backups
                    incrementais diários para total tranquilidade
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop
                          className="text-primary/15 dark:text-yellow-500/35"
                          stopColor="currentColor"
                        />
                        <stop
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Consulte informações com grandes volumes de dados históricos
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Dashboards executivos com KPIs fiscais em tempo real.
                      Identifique tendências, antecipe problemas e tome decisões
                      estratégicas baseadas em análises visuais precisas
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Gerencie permissões por perfil de usuário com precisão
                      cirúrgica. Defina quem pode visualizar, editar ou aprovar
                      cada operação.
                    </p>
                  </div>
                </div>
